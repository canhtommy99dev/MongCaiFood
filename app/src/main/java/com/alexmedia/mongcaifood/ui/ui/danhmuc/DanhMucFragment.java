...
public class DanhMucFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        array.add(new ViewPagerModel(R.drawable.iconansang,"Ăn Sáng"));
        array.add(new ViewPagerModel(R.drawable.iconantrua,"Ăn Trưa"));
        array.add(new ViewPagerModel(R.drawable.iconantoi,"Ăn Tối"));
        array.add(new ViewPagerModel(R.drawable.iconnhahang,"Nhà Hàng"));
        array.add(new ViewPagerModel(R.drawable.iconanvat,"Ăn Vặt"));
        array.add(new ViewPagerModel(R.drawable.iconlaunuong,"Lẩu Nướng"));
        array.add(new ViewPagerModel(R.drawable.iconbia,"Nhậu"));
        array.add(new ViewPagerModel(R.drawable.icondouong,"Đồ Uống"));
        array.add(new ViewPagerModel(R.drawable.iconmap,"Bản Đồ"));
