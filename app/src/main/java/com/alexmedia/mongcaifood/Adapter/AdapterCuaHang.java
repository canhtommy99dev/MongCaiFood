...
public class AdapterCuaHang extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ttxtench.setText(listDanhSaches.get(position).getTench());
        holder.ttxtDiahi.setText(listDanhSaches.get(position).getDiachi());
        holder.ttxtFacebook.setText(listDanhSaches.get(position).getFacebook());
        Glide.with(context).load(listDanhSaches.get(position).getImage()).centerCrop().into(holder.imgCuaHang);
